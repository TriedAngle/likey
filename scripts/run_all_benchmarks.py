...
def all_benchmarks() -> list[Benchmark]:
    benchmarks = [
        ...
        Benchmark(
            benchmark_id="dna/fsst-exact-fullscan/gencode",
            suite="dna",
            mode="fsst-exact-fullscan",
            case="gencode",
            result_subdir="dna/fsst-exact-fullscan",
            data_csv=Path("benchmarks/dna/data_gencode_dna_utf8_fsst.csv"),
            algorithms_csv=Path("benchmarks/dna/fsst-exact-fullscan/algorithms.csv"),
            patterns_csv=Path("benchmarks/dna/fsst-exact-fullscan/patterns.csv"),
            indexes_csv=Path("benchmarks/dna/fsst-exact-fullscan/indexes.csv"),
        ),
        Benchmark(
        ...
        Benchmark(
            benchmark_id="quotes/exact-vs-underscore-fullscan/quotes",
            suite="quotes",
            mode="exact-vs-underscore-fullscan",
            case="quotes",
            result_subdir="quotes/exact-vs-underscore-fullscan",
            data_csv=Path("benchmarks/quotes/data_quotes_utf8.csv"),
            algorithms_csv=Path("benchmarks/quotes/exact-vs-underscore-fullscan/algorithms.csv"),
            patterns_csv=Path("benchmarks/quotes/exact-vs-underscore/patterns.csv"),
            indexes_csv=Path("benchmarks/quotes/exact-vs-underscore-fullscan/indexes.csv"),
        ),
        Benchmark(
        ...
        Benchmark(
            benchmark_id="quotes/prefix-btree-exact/quotes",
            suite="quotes",
            mode="prefix-btree-exact",
            case="quotes",
            result_subdir="quotes/prefix-btree-exact",
            data_csv=Path("benchmarks/quotes/data_quotes_utf8.csv"),
            algorithms_csv=Path("benchmarks/quotes/prefix-btree-exact/algorithms.csv"),
            patterns_csv=Path("benchmarks/quotes/prefix-btree-exact/patterns.csv"),
            indexes_csv=Path("benchmarks/quotes/prefix-btree-exact/indexes.csv"),
        ),
        Benchmark(
        ...
        Benchmark(
            benchmark_id="quotes/fsst-exact-fullscan/quotes",
            suite="quotes",
            mode="fsst-exact-fullscan",
            case="quotes",
            result_subdir="quotes/fsst-exact-fullscan",
            data_csv=Path("benchmarks/quotes/data_quotes_utf8_fsst.csv"),
            algorithms_csv=Path("benchmarks/quotes/fsst-exact-fullscan/algorithms.csv"),
            patterns_csv=Path("benchmarks/quotes/fsst-exact-fullscan/patterns.csv"),
            indexes_csv=Path("benchmarks/quotes/fsst-exact-fullscan/indexes.csv"),
        ),
        Benchmark(
